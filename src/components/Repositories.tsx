...
const REPOS = [
  {
    name: 'agentanycast',
    description: 'Documentation, protocol definitions (proto/), examples. The main entry point for the project.',
    lang: 'Protobuf',
    langColor: '#e5d559',
    url: 'https://github.com/AgentAnycast/agentanycast',
  },
  {
    name: 'agentanycast-mcp',
    description: 'MCP server for Claude, Cursor, VS Code, and 13+ AI tools. One-line install with auto-detect script.',
    lang: 'Python',
    langColor: '#3572A5',
    url: 'https://github.com/AgentAnycast/agentanycast-mcp',
  },
  {
  ...
  },
  {
    ...
    description: 'Relay server — Circuit Relay v2, skill registry, multi-relay federation. Docker-deployable.',
    lang: 'Go',
    langColor: '#00ADD8',
  ...
  },
  {
    ...
    description: 'Python SDK — pip install agentanycast. CLI, 6 framework adapters (CrewAI, LangGraph, Claude, and more).',
    lang: 'Python',
    langColor: '#3572A5',
  ...
  },
  {
    ...
    description: 'TypeScript SDK — npm install agentanycast. CLI (agentanycast-ts), Node.js 18+, ES2022 modules.',
    lang: 'TypeScript',
    langColor: '#3178C6',
