...
const REPOS = [
  ...
  },
  {
    ...
    description: 'Core Go daemon — libp2p host, Noise_XX encryption, NAT traversal, A2A engine, HTTP bridge, MCP server, ANP bridge.',
    lang: 'Go',
    langColor: '#00ADD8',
  ...
  },
  {
    ...
    description: 'Relay server — Circuit Relay v2, skill registry, multi-relay federation, MCP server. Docker-deployable.',
    lang: 'Go',
    langColor: '#00ADD8',
  ...
  },
  {
    ...
    description: 'Python SDK — pip install agentanycast. Async/await API, CLI, adapters for CrewAI, LangGraph, Google ADK, OpenAI.',
    lang: 'Python',
    langColor: '#3572A5',
